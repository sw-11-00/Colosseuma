...
func (*MsgUpdateCoinSymbol) Descriptor() ([]byte, []int) {
	return fileDescriptor_749bcb183b8d6068, []int{4}
}
...
func (*MsgUpdateCoinSymbolResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_749bcb183b8d6068, []int{5}
}
...
func init() {
	...
	proto.RegisterType((*MsgUpdateCoinSymbol)(nil), "colosseuma.colosseuma.MsgUpdateCoinSymbol")
	proto.RegisterType((*MsgUpdateCoinSymbolResponse)(nil), "colosseuma.colosseuma.MsgUpdateCoinSymbolResponse")
}
...
var fileDescriptor_749bcb183b8d6068 = []byte{
	...
	,
}
...
func (c *msgClient) UpdateCoinSymbol(ctx context.Context, in *MsgUpdateCoinSymbol, opts ...grpc.CallOption) (*MsgUpdateCoinSymbolResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/colosseuma.colosseuma.Msg/UpdateCoinSymbol", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateCoinSymbol_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/colosseuma.colosseuma.Msg/UpdateCoinSymbol",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
