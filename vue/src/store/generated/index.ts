...
import ColosseumAColosseumaColosseuma from './ColosseumA/colosseuma.colosseuma'
...
export default { 
  ColosseumAColosseumaColosseuma: load(ColosseumAColosseumaColosseuma, 'colosseuma.colosseuma'),
